...
func NewTokenizerv2(r io.RuneReader) *Tokenizerv2 {
	return &Tokenizerv2{
		buffer:      []rune{},
		r:           r,
		tokenBuffer: []string{},
...
func (t *Tokenizerv2) peekRune() (rune, error) {
	var z rune
...
func (t *Tokenizerv2) readRune() (rune, error) {
	var z rune
...
func (t *Tokenizerv2) Token() (string, error) {
	var z string
...
func (t *Tokenizerv2) Peek() (string, error) {
	var z string
